...
<div id="sign-in-popup" class="b-popup-window">
	...
	<div class="b-popup-window_theme-1 b-popup-window_type-sign-in">
		<h2 class="b-popup-window__heading"><?=$arResult["FORM_TITLE"]?></h2>
...
<?}?>
		...
		?>
				<div class="b-form-field">
					<input type="tel" name="phone" value="" data-placeholder="<?=$arQuestion['CAPTION']?>" class="b-input-text" autocomplete="off" required>
				</div>
				<div class="b-form-field">
					<input type="email" name="mail" value="" data-placeholder="<?=$arQuestion['HTML_CODE']?>" class="b-input-text" autocomplete="off" required>
				</div>
		...
		<div class="b-form-submit">
			...
			<button type="submit" name="web_form_apply" class="b-button b-button_theme-1-L-send-app b-button_type-submit"></button>
		</div>
			</form>
		</div>
	</div>
