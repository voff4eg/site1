...
<?if($APPLICATION->GetCurPage() == "/reshit_problemu/proyti_test/"):?>
<div class="b-test-menu i-test-menu-step1">
	<menu class="b-test-menu__nav">
		<li class="b-test-menu__item b-test-menu__item1 i-test-menu__item__current">
		...
		<li class="b-test-menu__item b-test-menu__item3">
			<div class="b-test-menu__item__pointer"></div>
		</li>
		<div class="i-clearfix"></div>
	</menu>
...
<?elseif($APPLICATION->GetCurPage() == "/reshit_problemu/uznat_bolshe/"):?>
	<div class="b-test-menu i-test-menu-step2">
		<menu class="b-test-menu__nav">
			<li class="b-test-menu__item b-test-menu__item1">
				<a href="/reshit_problemu/proyti_test/" class="b-test-menu__link"></a>
				<div class="b-test-menu__item__pointer"></div>
			</li>
			<li class="b-test-menu__item b-test-menu__item2 i-test-menu__item__current">
				<div class="b-test-menu__item__pointer"></div>
			</li>
			<li class="b-test-menu__item b-test-menu__item3">
				<a href="/nayti_vracha/" class="b-test-menu__link"></a>
				<div class="b-test-menu__item__pointer"></div>
			</li>
			<div class="i-clearfix"></div>
		</menu>
